...
layer.config({
    ...
    if ($("#fixednavbar").click(function () {
            ...
            var oldSkin = getBodySkin();
            if( oldSkin == "" ) {
                return !1;
            }
            // return $("body").removeClass("skin-1"), $("body").removeClass("skin-2"), $("body").removeClass("md-skin"), $("body").removeClass("skin-3"), !1
            return $("body").removeClass(oldSkin), updateSysSkin(oldSkin, ""), !1;
        }), $(".s-skin-1").click(function () {
            var oldSkin = getBodySkin();
            if( oldSkin == "skin-1" ) {
                return !1;
            }
            // return $("body").removeClass("skin-2"), $("body").removeClass("skin-3"), $("body").removeClass("md-skin"), $("body").addClass("skin-1"), !1
            return $("body").removeClass(oldSkin), $("body").addClass("skin-1"), updateSysSkin(oldSkin, "skin-1"), !1;
        }), $(".s-skin-3").click(function () {
            var oldSkin = getBodySkin();
            if( oldSkin == "skin-3" ) {
                return !1;
            }
            // return $("body").removeClass("skin-1"), $("body").removeClass("skin-2"), $("body").removeClass("md-skin"), $("body").addClass("skin-3"), !1
            return $("body").removeClass(oldSkin), $("body").addClass("skin-3"), updateSysSkin(oldSkin, "skin-3"), !1;
        }),$(".md-skin").click(function () {
            var oldSkin = getBodySkin();
            if( oldSkin == "md-skin" ) {
                return !1;
            }
            // return $("body").removeClass("skin-1"), $("body").removeClass("skin-2"), $("body").removeClass("skin-3"), $("body").addClass("md-skin"),
            return $("body").removeClass(oldSkin), $("body").addClass("md-skin"), updateSysSkin(oldSkin, "md-skin"), !1;
        }), localStorageSupport) {
    ...
    function updateSysSkin( oldSkin, skin ) {
        $.ajaxSetup({ async: false});
        $.post( ctx+"/admin/auth/user/resetSkin", {"sysSkin": skin, "oldSkin": oldSkin}, function(resp) {
            if( resp.status == "success" ) {
                alert("更新皮肤成功！");
            } else {
                $("body").removeClass(skin).addClass(oldSkin);
            }
        }, "json" );
